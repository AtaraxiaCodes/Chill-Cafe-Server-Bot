	...
	execute(message, args) {
		const helpEmbed1 = new discord.MessageEmbed()
			...
			.addFields(
				...
				{
					name: `${prefix}profile`,
					value: 'Displays Rank and Level Data (WIP)'
				},
				{
					name: `${prefix}whois <member>`,
					value: "Displays a Member's Server Data"
				},
				{
					name: `${prefix}report <member>`,
					value: 'Report a Member for Moderator Review'
				}
			);
		...
		const helpEmbed2 = new discord.MessageEmbed()
			...
			.addFields(
				...
				{
					name: `${prefix}minesweeper <width> <height> <mines>`,
					value: 'Play a Minesweeper Game'
				},
				{
					name: `${prefix}coins <optional member>`,
					value: "Displays your coins or specified member's coins"
				},
			...
			.addFields(
				{
					...
					value: 'Plays Song w/ Provided YouTube URL'
				},
				{
					name: `${prefix}play <search query>`,
					value: 'Plays Song w/ Search Query'
				},
				{
					name: `${prefix}play <soundcloud url>`,
					value: 'Plays Song w/ Provide SoundCloud URL'
				},
				...
				{
					name: `${prefix}skipto <# in queue>`,
					value: 'Skips Current Song to Song in Queue'
				},
